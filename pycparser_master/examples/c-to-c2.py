...
from pycparser import parse_file, c_parser, c_generator, preprocess_file


def translate_to_c(filename):
    """ Simply use the c_generator module to emit a parsed AST.
    """
    ast = parse_file(filename, use_cpp=True, cpp_args="-IE:\\mycode\\python3\\pycparser\\utils\\fake_libc_include")
